            ...
            <div className="container">
              ...
              <div className="mwb-2col">
                <div className="mwb-left">
                  ...
                  <p>
                    Before building NontoNime.id, we've checked many other free anime sites,
                    and learnt from them. We only keep the good things and remove all the
                    bad things from all the competitors, to put it in our HiAnime website.
                    Let's see how we're so confident about being the best site for anime
                    streaming:
                  </p>
                  <ul>
                    <li>
                    ...
                    <li>
                      ...
                      resolution, the best quality possible. NontoNime.id also has a quality
                      setting function to make sure our users can enjoy streaming no
                      matter how fast your Internet speed is. You can stream the anime at
                      360p if your Internet is being ridiculous, Or if it is good, you can
                      go with 720p or even 1080p anime.
                    </li>
                    <li>
                    ...
                    <div className="connecting-list">
                      ...
                      <div className="item">
                        ...
                        <div className="subject">
                          <div>
                            ...
                            link guys ✌🏻 This "you creep" thinks my ahh is on HiAnime the
                            whole day. Gotta deadahh show him who're the bosses around
                        ...
                        <div className="cn-owner">
                          ...
                          >
                            <i className="badg-level level-a up-4" />
                            XX_JJMaGnAnIMuZz_XX
                            <span>Dolphin</span>
                          </a>
                        </div>
                      ...
                      <div className="item">
                        ...
                        <div className="subject">
                          <div>
                            ...
                            (hianimez.to/community/post/showdown-of-the-main-characters-round-2-261876)
                      ...
                      <div className="item">
                        ...
                        <h4 className="item-name">
                          <a
                            href="#"
                            title="For those who think aot is mid."
                          >
                        ...
                        <div className="cn-owner">
                          ...
                          <a
                            ...
                            className="user-name is-level-x is-level-a"
                          >
                            <i className="badg-level level-a" />
                            emmerseave
                            <span>Angelfish</span>
                          </a>
                        </div>
