      ...
      <div className="mw-body">
        <div className="container">
          <div className="share-buttons share-buttons-home">
            <div className="container">
              <div className="share-buttons-block" style={{display: 'flex', justifyContent: 'center'}}>
                <div className="share-icon" />
                <div className="sbb-title mr-3">
                  <span>Share Nontonime</span>
                  <p className="mb-0">to your friends</p>
                </div>
                <div className="sbb-social"><div className="sharethis-inline-share-buttons st-center st-has-labels  st-inline-share-buttons st-animated" id="st-1"><div className="st-btn st-first" data-network="facebook" style={{display: 'inline-block'}}>
                    ...
                    </div><div className="st-btn" data-network="email" style={{display: 'inline-block'}}>
                      <img alt="email sharing button" src="https://platform-cdn.sharethis.com/img/email.svg" />
                      <span className="st-label">Email</span>
                    </div><div className="st-btn st-remove-label" data-network="whatsapp" style={{display: 'inline-block'}}>
                      <img alt="whatsapp sharing button" src="https://platform-cdn.sharethis.com/img/whatsapp.svg" />
                      <span className="st-label">Share</span>
                    </div><div className="st-btn st-last  st-remove-label" data-network="sharethis" style={{display: 'inline-block'}}>
          ...
          <div className="mwb-2col">
            <div className="mwb-left">
              ...
              <p>
                Nontonime is a free site to watch anime and you can even download subbed or
                dubbed anime in
              ...
              <h2>3/ So what make
                Nontonime the best site to watch anime free online?
              </h2>
              <p>Before building
                Nontonime, we've checked many other free anime sites, and learnt
                from them.
                We
                only keep the good things and remove all the bad things from all the competitors, to put
                it
                in our
                Nontonime website. Let's see how we're so confident about being the best
                site for
                anime
                streaming:
              </p>
              <ul>
                ...
                <li><strong>Quality/Resolution:</strong> All titles are in excellent resolution, the
                  best
                  quality possible.
                  Nontonime also has a quality setting function to make
                  sure our users
                  can
                ...
                <li><strong>Streaming experience:</strong> Compared to other anime streaming sites, the
                  loading speed at
                  Nontonime is faster. Downloading is just as easy as
                  streaming, you
                  won't
                ...
                <li><strong>Device compatibility:</strong>
                  Nontonime works alright on both your
                  mobile and
              ...
              <p>So if you're looking for a trustworthy and safe site for your Anime streaming, let's give
                Nontonime a try. And if you like us, please help us to spread the words and do
                not forget
                to
                bookmark our site.
              </p>
            ...
            <div className="mwb-right">
              <div className="zr-connect zr-connect-list">
                <h2 className="heading-news">Trending Posts<i className="fa-solid fa-person-digging" /></h2>
                  ...
                  <div className="item">
                    <div className="gi-top d-flex justify-content-between align-items-center">
                      <div className="ztag">
                        ...
                        <div className="time d-inline"><span><i className="dot mr-2" />2 days ago</span></div>
                      </div>
                      <div className="gi-stats d-flex align-items-center">
                        <div className="ml-4"><i className="fas fa-comment mr-1" />15</div>
                      </div>
                    </div>
                    <h4 className="item-name"><a href="/community/post/constructing-new-features-243342">Constructing New Features for Our Platform</a></h4>
                    ...
                    <div className="cn-owner">
                      ...
                      <a href="https://dcd.gg/#" className="user-name is-level-x is-level-a">
                ...
                <div className="d-block">
                  <a href="https://dcd.gg/#" className="btn btn-sm py-2 btn-block btn-radius btn-blank text-white" style={{backgroundColor: 'rgba(255,255,255,.1)'}}>Join our Discord</a>
                </div>
              </div>
            </div>
            <div className="clearfix" />
