    ...
    return (
        <div className="bg-[#201F31] w-full h-screen flex justify-center items-center">
            <div className="flex flex-col w-fit h-fit items-center justify-center">
                <img src="https://wsrv.nl/?url=https://cdn.statically.io/gh/senna-js/zenime-id/main/public/404.png" alt="" className="w-[300px] h-[300px] max-[500px]:w-[200px] max-[500px]:h-[200px]" />
